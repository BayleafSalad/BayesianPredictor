...
destination using a naive baysian algorithm.
It's a little bit like how AI works anyway.  Training data is used to predict the next destination.  Pretty neat.
This was just for fun/educational purposes. I hope you like it!

Not responsible if some moron somehow uses this to harm someone else.  Idk. Don't hit anyone over the head with your laptop while using this program.
